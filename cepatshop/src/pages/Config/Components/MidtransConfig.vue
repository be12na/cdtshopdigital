...
onMounted(() => {
   if (config.value) {
      callback_url.value = config.value.midtrans_callback
   }
   getData()
})
</script>
         ...
         <form @submit.prevent="updateData">
            ...
            <div class="q-pt-sm">
               <div class="q-gutter-y-sm">
                  ...
                  <q-select :options="envModes" filled v-model="form.midtrans_mode" label="Api Mode" />
                  <q-input filled v-model="form.midtrans_merchant_id" label="Midtrans Merchant Id" />
                  <q-input filled v-model="form.midtrans_server_key" label="Midtrans Server Key" />
                  <q-input filled v-model="form.midtrans_client_key" label="Midtrans Client Key" />
