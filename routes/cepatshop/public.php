...
Route::middleware(['conditional.get', 'cache.headers:public;max_age=60;etag'])->group(function () {
...
Route::middleware(['conditional.get', 'cache.headers:public;max_age=300;etag'])->group(function () {
...
Route::post('products/{slug}/checkout', [FrontOrderController::class, 'productCheckout']);
